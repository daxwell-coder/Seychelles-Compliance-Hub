  ...
  return (
    <div className={`min-h-screen relative text-white ${inter.className}`} style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* Key Benefits Row - Always Visible */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Information Column - Always Visible */}
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-300 flex items-center">
                🔍 What We'll Review
              </h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-3 text-lg">•</span>
                  <span>Historical compliance filing status and accuracy</span>
                </li>
                <li className="flex items-start">
                  <span className="text-cyan-400 mr-3 text-lg">•</span>
                  <span>Current beneficial ownership structure verification</span>
                </li>
                <li className="flex items-start">
                  <span className="text-teal-400 mr-3 text-lg">•</span>
                  <span>Outstanding regulatory obligations assessment</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-3 text-lg">•</span>
                  <span>Registered agent verification and updates</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-3 text-lg">•</span>
                  <span>AML/CFT compliance gap identification</span>
                </li>
              </ul>
            </div>

            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-300 flex items-center">
                ✅ Migration Services
              </h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-green-400 mr-3 text-lg">•</span>
                  <span>Complete compliance gap analysis with prioritization</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-3 text-lg">•</span>
                  <span>Automated filing catch-up service with penalties avoided</span>
                </li>
                <li className="flex items-start">
                  <span className="text-teal-400 mr-3 text-lg">•</span>
                  <span>AI-powered ongoing compliance automation setup</span>
                </li>
                <li className="flex items-start">
                  <span className="text-cyan-400 mr-3 text-lg">•</span>
                  <span>Real-time regulatory update notifications</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-400 mr-3 text-lg">•</span>
                  <span>Annual compliance health checks and optimization</span>
                </li>
              </ul>
            </div>

            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-300 flex items-center">
                💰 Pricing Structure
              </h3>
        ...
        {response && (
          <div className="mt-12 bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
            <h2 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-300 flex items-center">
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                  ...
                  {response.data.riskAssessment.urgentIssues.length > 0 && (
                    <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                      <h4 className="text-sm font-semibold text-red-400 mb-3">⚠️ Urgent Issues Detected:</h4>
